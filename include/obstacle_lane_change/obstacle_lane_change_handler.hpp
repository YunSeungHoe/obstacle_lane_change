#ifndef OBSTACLE_LANE_CHANGE__OBSTACLE_LANE_CHANGE_HANDLER_HPP_
#define OBSTACLE_LANE_CHANGE__OBSTACLE_LANE_CHANGE_HANDLER_HPP_
...
namespace obstacle_lane_change_handler
{
...
class ObstacleLaneChangeHandler
{
public:
  ObstacleLaneChangeHandler() = default;
  explicit ObstacleLaneChangeHandler(const HADMapBin & map_msg);
  ...
  lanelet::routing::RelationType getRelation(const lanelet::ConstLanelet & prev_lane, const lanelet::ConstLanelet & next_lane) const;
...
private:
  ...
  rclcpp::Logger logger_{rclcpp::get_logger("obstacle_lane_change_handler")};
...
#endif  // OBSTACLE_LANE_CHANGE__OBSTACLE_LANE_CHANGE_HANDLER_HPP_
